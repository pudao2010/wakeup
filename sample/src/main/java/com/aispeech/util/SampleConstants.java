...
public class SampleConstants {
	 ...
	 * AEC资源设置
	 */
	public final static String RES_AEC = "AEC_ch2-2-ch1_1ref_com_20171227_v0.8.5.bin";

	/**
	 * 识别相关资源
	 */
	public final static String RES_EBNFC = "ebnfc.aihome.0.3.0.bin";
	public final static String RES_EBNFR = "ebnfr.aihome.0.3.0.bin";
	 ...
	 *  合成资源文件
	 */
	public final static String RES_TTS = "qianranc_common_param_ce_local.v2.022.bin";
	public final static String RES_DICT = "aitts_sent_dict_v3.24.db";
